...
<table>
  <tr>
    <td style="border-style: hidden">
      <h1><img style="display: block; margin-left: auto; margin-right: auto; width: 100%; border-radius: 10px" src="https://jcentercreation.github.io/JekyllPersonalWeb/assets/img/techOffice3.svg"></h1>
    </td>
  </tr>
</table>
...
<table style="width: 100%">
  <tr>
    <td style="border-style: hidden; width: 50%; vertical-align: center"><script charset="utf-8" type="text/javascript" src="//js-eu1.hsforms.net/forms/shell.js"></script><script>hbspt.forms.create({region: "eu1",portalId: "24911257",formId: "07fe559d-ca81-41ad-b091-f3d32cd5bd93"});</script>
    </td>
