...
<table style="table-layout: fixed; width: 450px">
  ...
  <tr>
    ...
    <td style="font-size: 150%; text-align: left; background-color: #FDFDFD; table-layout: fixed; width: 300px; height: 30px; border-style: hidden; margin: 1px; padding: 1px"></td>
  </tr>
</table>
