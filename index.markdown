...
<table style="table-layout: fixed; width: 450px">
  ...
  <tr>
    <td style="font-size: 90%; text-align: left; background-color: #F8FAFC; table-layout: fixed; width: 50px; height: 3px; border-style: hidden; margin: 1px; padding: 1px">Notes, highlights and reviews of my favourite books, both fiction and non-fiction ones.</td>
  </tr>
   <tr>
