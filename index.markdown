...
<table style="table-layout: fixed; width: 750px">
  <caption></caption>
  <tr>
    <td style="table-layout: fixed; width: 375px; height: 200px; font-size: 100%; text-align: center; background-color: #FDFDFD; border-style: hidden; margin: 1px; padding: 1px"><h2 style="text-align: justify">I'm Javier Carrillo, an engineer and athlete.</h2>
    ...
    <td style="table-layout: fixed; width: 375px; height: 200px; font-size: 100%; text-align: center; background-color: #FDFDFD; border-style: hidden; margin: 1px; padding: 1px"></td>
  </tr>
</table>
