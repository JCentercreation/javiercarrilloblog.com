  ...
  <table style="width: 100%; padding: 0px; border-style: hidden; text-align: left">
    <tr>
      ...
      <td style="width: 35%; border-style: hidden; text-align: right">
        <img style="display: block; margin-left: auto; margin-right: auto; height: 270px; width: 100%; object-fit: contain" src="https://jcentercreation.github.io/JekyllPersonalWeb/assets/img/img8.PNG">
      </td>
    </tr>
  </table>
</header>
