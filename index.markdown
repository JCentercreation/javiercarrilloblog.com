...
<table style="table-layout: fixed; width: 750px">
  ...
  <tr>
    ...
    <td style="table-layout: fixed; width: 375px; height: 200px; font-size: 100%; text-align: center; background-color: #FDFDFD; border-style: hidden; margin: 10px; padding: 1px"></td>
  </tr>
</table>
