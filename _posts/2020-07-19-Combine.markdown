...
<br>
<img style="display: block; margin-left: auto; margin-right: auto; width: 100%; object-fit: contain; border-radius: 10px" src="/assets/img/combineStructure.png">
<p>Source: Apple Inc. (WWDC 2019)</p>
<br>
...
In this short tutorial we are going to explain basic concepts of Combine in a hands-on approach by building a URL JSON request, which I think is widely used in the most of the Apps. 
