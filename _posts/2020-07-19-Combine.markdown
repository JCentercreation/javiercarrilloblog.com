...
Basically a `Publisher` generate values that can change on which a `Sbuscriber` subscribes to receive all those updates. If you've been working lately with SwiftUI you may have use Property Wrappers like `@ObservableObject`
