...
<table style="border-bottom: 1px solid #F2F2F2; border-top: 0px solid #000; border-right: 0px solid #000; border-left: 0px solid #000">
  <tr> 
    ...
    <td style="table-layout: fixed; width: 400px; background-color: #FDFDFD; border-bottom: 1px solid #F2F2F2; border-top: 0px solid #000; border-right: 0px solid #000; border-left: 0px solid #000"><a style="font-size: 20px; color: #000" href="https://www.javiercarrilloblog.com/article/17/05/2021/NotificationsIniOS.html">Notifications in iOS</a></td>
  </tr>
  <tr> 
